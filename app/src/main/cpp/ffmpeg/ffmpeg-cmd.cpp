...
Java_com_haichenyi_community_jni_FFmpegCmd_run(JNIEnv *env, jclass type, jint cmdLen,
                                               jobjectArray cmd) {
    //set java vm
    JavaVM *jvm = NULL;
    env->GetJavaVM(&jvm);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_haichenyi_community_jni_FFmpegCmd_getProgress(JNIEnv *env, jclass clazz) {
    return get_progress();
}

extern "C"
JNIEXPORT jdouble JNICALL
Java_com_haichenyi_community_jni_FFmpegCmd_getSpeed(JNIEnv *env, jclass clazz) {
    return get_speed();
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_haichenyi_community_jni_FFmpegCmd_retrieveInfo(JNIEnv *env, jclass clazz, jstring _path) {
    ...
    buffer << "{\"rotation\":" << rotation << ",\"width\":" << width << ",\"height\":" << height
           << ",\"duration\":" << duration << ",\"bitrate\":" << bitrate << ",\"fps\":" << fps
           << R"(,"videoCodec":")" << vCodecName << "\"}";
